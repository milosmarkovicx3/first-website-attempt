...
/*---------------------------------------------------------------------------------*/
function pokreni(){
    var poslao = localStorage.getItem('ime')+" "+localStorage.getItem('prezime')+", "+localStorage.getItem('posiljalac');
        document.getElementById('posiljalac').innerHTML = poslao;
        document.getElementById('vreme').innerHTML = localStorage.getItem('vreme');
        document.getElementById('naslov').innerHTML = localStorage.getItem('naslov');
        document.getElementById('poruka').innerHTML = localStorage.getItem('poruka');
}
window.addEventListener('DOMContentLoaded', pokreni);
/*---------------------------------------------------------------------------------*/